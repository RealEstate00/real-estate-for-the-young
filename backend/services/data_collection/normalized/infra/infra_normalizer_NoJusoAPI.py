...
class CoordinateAPI:
    ...
    def _load_bcode_data(self) -> Dict[str, str]:
        ...
        bcode_file = Path(__file__).resolve().parents[4] / "data" / "법정동코드 전체자료.txt"
...
if __name__ == "__main__":
    ...
    openseoul_data_path = project_root / "data" / "public-api" / "openseoul"
    
    normalizer = InfraNormalizer(data_dir=openseoul_data_path)
    output_dir = project_root / "data" / "normalized" / "infra"
